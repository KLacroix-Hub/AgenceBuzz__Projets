<?php
class Case_Studie extends Post
{
	const POST_TYPE = "case-studie";
	const VIEW_THUMB = 'molecules/m-cases-studies-thumb';
	...
	public static function API_get_case_studies(WP_REST_Request $request){
